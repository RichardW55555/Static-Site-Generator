...
class TestSplitDelimiter(unittest.TestCase):
    ...
    def test_bold_double_split(self):
        node = TextNode(
    ...
    def test_bold_multiword_split(self):
        node = TextNode(
            "This is text with a **bolded word** and **another**", TextType.TEXT
        )
        new_nodes = split_nodes_delimiter([node], "**", TextType.BOLD)
    ...
    def test_unmatched_delimiters_split(self):
        node = TextNode("`print(\"Hello World\")", TextType.TEXT)
    ...
    def test_split_link_single(self):
        ...
        self.assertListEqual(
            [
                TextNode("link", TextType.LINK, "https://www.example.COM/LINK"),
            ],
            new_nodes,
        )
